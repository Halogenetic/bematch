  ...
  return (
    <div className='h-auto flex flex-col items-center justify-center'>
      ...
      <div id="myprofilebox" className='flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-wrap items-center justify-center mt-[30px]'>{data.data.tags?.map((tag: string | null | undefined, index: number) => tag ? <div key={index} id='mytags'>{tag}</div> : null)}</div>
      </div>
    </div>
